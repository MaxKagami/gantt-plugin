  ...
  module Baseline
    class SaveIssueDates
      ...
      def drop_absent(baseline:, sources:)
        start_field = make_field(I18n.t('baselines.custom_fields.name_plan_start_date'))
        end_field = make_field(I18n.t('baselines.custom_fields.name_plan_end_date'))
